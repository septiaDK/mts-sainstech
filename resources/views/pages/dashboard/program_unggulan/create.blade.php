        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                <li class="flex items-center">
                    <a href="{{ route('admin.program_unggulan.index') }}" class="text-gray-400">Prestasi</a>
                ...
                <li class="flex items-center">
                    <p class="font-medium">Tambah Program Unggulan</p>
                </li>
            </ol>
        </nav>
            ...
            <div class="grid gap-5 md:grid-cols-12">
                <main class="col-span-12 p-4 md:pt-0">
                    <div class="px-2 py-2 mt-2 bg-white rounded-xl">
                        ...
                        <form action="{{ route('admin.program_unggulan.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="plogo" type="file" name="logo" id="logo"
                                                autocomplete="logo"
