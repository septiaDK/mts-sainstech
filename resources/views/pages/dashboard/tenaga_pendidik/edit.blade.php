    ...
    <main class="h-full overflow-y-auto">
        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <p class="font-medium">Edit Tenaga Pendidik</p>
                </li>
            </ol>
        </nav>
            ...
            <div class="grid gap-5 md:grid-cols-12">
                <main class="col-span-12 p-4 md:pt-0">
                    <div class="px-2 py-2 mt-2 bg-white rounded-xl">
                        ...
                        <form action="{{ route('admin.tenaga_pendidik.update', [$tenaga_pendidik->id]) }}" method="POST"
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Nama ?" type="text" name="name" id="name"
                                                ...
                                                value="{{ $tenaga_pendidik->name ?? '' }}" required>
