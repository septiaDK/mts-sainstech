<div class="bg-serv-button mx-auto text-white text-xs" style="font-family: 'Poppins', sans-serif">
    <div class="flex flex-col md:flex-row justify-between px-2 py-2">
                    ...
                    <div @click.away="open = false" class="relative {{ request()->is(['kurikulum', 'prestasi', 'ekstrakurikuler', 'organisasi']) ? 'nav-link active font-medium' : 'nav-link text-serv-text' }}" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                            ...
                            <div class="px-2 py-2 bg-white rounded-md shadow dark-mode:bg-gray-800">
                                <a class="block px-4 py-2 mt-2 text-sm bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline {{ request()->is('kurikulum') ? 'active font-medium' : 'text-serv-text' }}"
                                    href="{{ route('landing.kurikulum') }}">Kurikulum</a>

                                <a class="block px-4 py-2 mt-2 text-sm bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline {{ request()->is('prestasi') ? 'active font-medium' : 'text-serv-text' }}"
                                    href="{{ route('landing.prestasi') }}">Prestasi</a>


                                <a class="block px-4 py-2 mt-2 text-sm bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline {{ request()->is('ekstrakurikuler') ? 'active font-medium' : 'text-serv-text' }}"
                                    href="{{ route('landing.ekstrakurikuler') }}">Ekstrakurikuler</a>


                                <a class="block px-4 py-2 mt-2 text-sm bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline {{ request()->is('organisasi') ? 'active font-medium' : 'text-serv-text' }}"
                                    href="{{ route('landing.organisasi') }}">Organisasi</a>
                            </div>
                        </div>
                    </div>
                </nav>
